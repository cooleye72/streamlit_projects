...
def get_course_details(category_and_product_response: list[dict]):
    course_names_list = []
    for x in category_and_product_response: #category_and_product_response
...
def generate_response_based_on_course_details(user_message, course_details):
    delimiter = "####"
    ...
    Make sure to include {delimiter} to separate every step. Do not include delimiters at the end of your response. 
    """
...
def process_user_message(user_input):
    ...
    #print("response to customer : ", reply)
    return reply
